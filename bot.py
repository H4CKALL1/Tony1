...
BOT_TOKEN = '7522198105:AAHv3Epb3A3raW1oOD0e67QVXKZxXBf8bq4'
...
async def button(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == 'lang_en':
        text = "In English: All users create a new account and register. After registration you have to deposit ₹200, ₹500 as shown in the photo below and send your hack photo and GoaGame photo to the below id then you And then you will be given the key 🔐"
    elif query.data == 'lang_hi':
        text = "हिंदी में: सभी उपयोगकर्ता एक नया खाता बनाएं और पंजीकरण करें। रजिस्ट्रेशन के बाद आपको नीचे फोटो में दिखाए अनुसार ₹200, ₹500जमा करने होंगे और अपनी हैक फोटो और GoaGame फोटो नीचे दी गई आईडी पर भेजनी होगी फिर आपको hack key 🔐 दिया जायगा ।"
    elif query.data == 'lang_gu':
        text = "ગુજરાતીમાં: બધા યુઝર નવું એકાઉન્ટ બનાવી લો અને રજીસ્ટર કરી લેજો. રજિસ્ટર કરિયા બાદ નીચે  ફોટો માં બતાવ્યાં મુજબ ₹200, ₹500 ડિપોઝિટ કરીને તમારા hack નો ફોટો અને GoaGame  નો ફોટો નીચે આપેલી id પર મોકલવો પડશે પછી તમને હેક ની key 🔐 આપવા માં આવશે"
